...
<template>
  <div class="login-left-view">
    ...
    <div class="geometric-decorations">
      ...
      <!-- 装饰点 -->
      <div class="geo-element dot dot-top-left animate-dot-in" style="animation-delay: 0s"></div>
      <div class="geo-element dot dot-top-right animate-dot-in" style="animation-delay: 0s"></div>
      <div
        class="geo-element dot dot-center-right animate-dot-in"
        style="animation-delay: 0s"
      ></div>
