...
<template>
  <div
    v-if="showWorkTab"
    class="art-worktab-bar box-border flex-b w-full px-5 mb-3 select-none max-sm:px-[15px]"
    :class="[
  ...
  >
    <div class="art-worktab-viewport w-full overflow-hidden" ref="scrollRef">
      <ul
        class="art-worktab-list float-left whitespace-nowrap !bg-transparent flex"
    ...
    <div class="art-worktab-actions flex">
      <div
