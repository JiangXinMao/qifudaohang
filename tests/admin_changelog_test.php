...
check_admin_changelog(strpos($brand, "QIFU_PRODUCT_VERSION', 'V1.8'") !== false, 'installed product version is not current');
check_admin_changelog(strpos($data, "version: 'V1.8'") !== false, 'bundled changelog is not aligned with the installed version');
